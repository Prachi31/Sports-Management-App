...
import prachi14075.iiitd.ac.in.sportsmanagementapp.fragment.OngoingEventDetailsTabFragment;

public class OngoingEventDetailsPagerAdapter extends FragmentPagerAdapter implements PagerSlidingTabStrip.CustomTabProvider{
    ...
    public OngoingEventDetailsPagerAdapter(FragmentManager fm, Context mContext) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        switch (position){
            case 0:
                fragment = new OngoingEventDetailsTabFragment();
                break;
            case 1:
