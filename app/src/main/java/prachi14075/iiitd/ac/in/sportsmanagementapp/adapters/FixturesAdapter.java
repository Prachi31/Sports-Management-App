...
public class FixturesAdapter extends RecyclerView.Adapter<FixturesAdapter.ViewHolder>{
    ...
    int flag = 1;
    public FixturesAdapter(Context mContext, ArrayList<FixturesDTO> mFixtureRoundsList) {
    ...
    @Override
    public void onBindViewHolder(final FixturesAdapter.ViewHolder holder, int position) {
    ...
    private void addFixturesListData(final FixturesAdapter.ViewHolder holder, int position) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        FixtureDetailsAdapter   matchDetailsAdapter;
        ...
        ViewHolder(View itemView) {
            ...
            matchDetailsAdapter = new FixtureDetailsAdapter(mContext,matchDetailsList);
        }
    }
}
