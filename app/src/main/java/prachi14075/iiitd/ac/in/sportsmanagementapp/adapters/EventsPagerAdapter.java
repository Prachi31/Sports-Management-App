...
public class EventsPagerAdapter extends FragmentPagerAdapter implements PagerSlidingTabStrip.CustomTabProvider{
    ...
    public EventsPagerAdapter(Context context, FragmentManager fm) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        switch (position){
            case 0:
                fragment = new OngoingEventsFragment();
                break;
            case 1:
