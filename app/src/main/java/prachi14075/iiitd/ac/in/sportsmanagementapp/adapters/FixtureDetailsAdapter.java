...
public class FixtureDetailsAdapter extends RecyclerView.Adapter<FixtureDetailsAdapter.ViewHolder>{

    Context mContext;
    private ArrayList<MyMatchesDTO> mFixturesList;

    public FixtureDetailsAdapter(Context mContext, ArrayList<MyMatchesDTO> mFixturesList) {
        this.mContext = mContext;
        this.mFixturesList = mFixturesList;
    }

    @Override
    public FixtureDetailsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_fixtures_matches, parent, false);
        return new ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(FixtureDetailsAdapter.ViewHolder holder, int position) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            teamOneScoreText   = (TextView)     itemView.findViewById(R.id.item_fixtures_score_team_one);
            teamTwoScoreText   = (TextView)     itemView.findViewById(R.id.item_fixtures_score_team_two);
