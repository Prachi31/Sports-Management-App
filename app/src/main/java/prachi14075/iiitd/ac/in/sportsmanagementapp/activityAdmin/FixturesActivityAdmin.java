...
import prachi14075.iiitd.ac.in.sportsmanagementapp.adaptersAdmin.FixturesAdapterAdmin;
import prachi14075.iiitd.ac.in.sportsmanagementapp.dtos.FixturesDTO;

public class FixturesActivityAdmin extends AppCompatActivity {
    ...
    FixturesAdapterAdmin mFixturesAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fixtures_admin);
        initializeViews();
        setUpToolbar();
        setUpFixturesList();
    }
    ...
    private void setUpFixturesList() {
        ...
        mFixturesAdapter       = new FixturesAdapterAdmin(getApplicationContext(), mFixturesList);
    ...
    private void initializeViews() {
        mFixturesRecyclerView = (RecyclerView) findViewById(R.id.activity_fixtures_recycler_view_admin);
    }
