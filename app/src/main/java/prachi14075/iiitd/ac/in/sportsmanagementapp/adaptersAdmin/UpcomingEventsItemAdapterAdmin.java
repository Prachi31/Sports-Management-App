...
public class UpcomingEventsItemAdapterAdmin extends RecyclerView.Adapter<UpcomingEventsItemAdapterAdmin.ViewHolder>{

    private Context mContext;
    private ArrayList<UpcomingEventsDTO> mUpcomingEventsDTOArrayList;

    public UpcomingEventsItemAdapterAdmin(Context mContext, ArrayList<UpcomingEventsDTO> mUpcomingEventsDTOArrayList) {
        this.mContext = mContext;
        this.mUpcomingEventsDTOArrayList = mUpcomingEventsDTOArrayList;
    }

    @Override
    public UpcomingEventsItemAdapterAdmin.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(UpcomingEventsItemAdapterAdmin.ViewHolder holder, int position) {
    ...
    private void addUpcomingEventsListData(UpcomingEventsItemAdapterAdmin.ViewHolder holder, int number_of_tags) {
