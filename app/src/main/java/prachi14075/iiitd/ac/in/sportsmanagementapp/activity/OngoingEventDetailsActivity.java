...
public class OngoingEventDetailsActivity extends AppCompatActivity {
    ...
    OngoingEventDetailsPagerAdapter mTabsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ongoing_event_details);
        initializeViews();
        setUpToolbar();
    ...
    private void setUpPagerAdapter() {
        mTabsPagerAdapter = new OngoingEventDetailsPagerAdapter(getSupportFragmentManager(), getApplicationContext());
...
//        getSupportActionBar().setDisplayUseLogoEnabled(true);
    ...
    private void initializeViews() {
        ...
        mOngoingEventDetailsViewPager      = (ViewPager)findViewById(R.id.activity_ongoing_event_details_viewpager);
